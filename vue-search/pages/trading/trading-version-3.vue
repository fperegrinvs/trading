...
<div>
    ...
    <trading-vue ref="tradingVue" @click.native="onclick" :toolbar="true" :data="data" :titleTxt="chartTitle" :overlays="overlays" :width="width" :height="height" colorBack="#161A1E" colorGrid="#1B1F24" colorCandleUp="#0ECB81" colorCandleDw="#F6465D"></trading-vue>
</div>
...
export default {
    ...
    methods: {
        ...
        onclick() {
            ...
            console.log(this.$refs.tradingVue.getCursor().values['0'].ohlcv)
        },
